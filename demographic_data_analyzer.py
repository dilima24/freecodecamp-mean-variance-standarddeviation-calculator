...
def calculate_demographic_data(print_data=True):
    ...
    total_number_of_countries = df['native-country'].value_counts()
    country_rich = df[df['salary'] == '>50K']['native-country'].value_counts()
    country_percentages = (country_rich / total_number_of_countries) * 100
    ...
    india_50Kgreater=df[(df['native-country']=='India')&(df['salary']=='>50K')]
    top_IN_occupation = india_50Kgreater['occupation'].value_counts().idxmax()
